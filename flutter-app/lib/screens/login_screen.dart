                ...
                child: SlideTransition(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              ...
                              colors: [Color(0xFFE8CD5A), Color(0xFFD4B254), Color(0xFFB5973F), Color(0xFF8B7332)],
                            ),
                            borderRadius: BorderRadius.circular(26),
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFFD4B254).withValues(alpha: 0.4),
                                blurRadius: 28,
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: Icon(Icons.email_outlined, size: 20, color: cs.onSurfaceVariant),
                          ),
                        ),
                        ...
                        onSubmitted: _isLoading
                            ? null
                            : (_) => _run(() => widget.authService.signInEmailPassword(
                      ...
                      Row(
                        children: [
                          Expanded(child: Divider(color: goldAccent.withValues(alpha: 0.15))),
                          Padding(
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          ...
                          icon: Icon(Icons.g_mobiledata, size: 24, color: isDark ? Colors.white : null),
                      ...
                      if (_successMessage != null) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFF388E3C).withValues(alpha: isDark ? 0.15 : 0.08),
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: const Color(0xFF388E3C).withValues(alpha: isDark ? 0.3 : 0.2),
                              width: 0.5,
                            ),
                          ),
                          child: Row(
                            children: [
                              const Icon(Icons.check_circle_outline, color: Color(0xFF388E3C), size: 20),
                              const SizedBox(width: 10),
                              Expanded(
                                child: Text(
                                  _successMessage!,
                                  style: const TextStyle(color: Color(0xFF388E3C), fontSize: 13, height: 1.4),
                                ),
                              ),
                            ],
                          ),
                      ...
                      if (_error != null) ...[
                        ...
                        Container(
                          padding: const EdgeInsets.all(14),
                          decoration: BoxDecoration(
                            color: const Color(0xFFD32F2F).withValues(alpha: isDark ? 0.15 : 0.08),
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: const Color(0xFFD32F2F).withValues(alpha: isDark ? 0.3 : 0.2),
                              width: 0.5,
                            ),
                          ),
                          child: Column(
