...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'ingots_coins': 'Ingots & Coins',
      'ingots_24k': '24K Ingots',
      'coins_21k': '21K Coins',
      'manufacturer': 'Manufacturer',
      'weight': 'Weight',
      'gram_price': 'Price per gram',
      'manufacturing_fee': 'Manufacturing/gram',
      'total_price': 'Total price',
      'cashback_per_gram': 'Cashback/gram',
      'resale_price': 'Resale price',
      'expected_loss': 'Expected loss',
      'quarter_pound_coin': 'Quarter Pound',
      'half_pound_coin': 'Half Pound',
      'full_pound_coin': 'Gold Pound',
      ...
      'contact_us_subtitle': 'We are happy to receive your complaints or app suggestions',
      'subject': 'Subject',
    ...
    'ar': {
      ...
      'ingots_coins': 'السبائك والعملات',
      'ingots_24k': 'سبائك عيار 24',
      'coins_21k': 'عملات عيار 21',
      'manufacturer': 'الشركة المصنعة',
      'weight': 'الوزن',
      'gram_price': 'سعر الجرام',
      'manufacturing_fee': 'المصنعية/جرام',
      'total_price': 'السعر الإجمالي',
      'cashback_per_gram': 'الكاش باك/جرام',
      'resale_price': 'سعر إعادة البيع',
      'expected_loss': 'الخسارة المتوقعة',
      'quarter_pound_coin': 'ربع جنيه',
      'half_pound_coin': 'نصف جنيه',
      'full_pound_coin': 'جنيه ذهب',
      ...
      'contact_us_subtitle': 'يسعدنا تلقي شكواك أو اقتراحاتك لتطوير التطبيق',
      'subject': 'الموضوع',
      'your_message': 'رسالتك',
      'send': 'إرسال',
